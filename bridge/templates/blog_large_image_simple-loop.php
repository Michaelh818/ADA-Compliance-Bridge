...
?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			<div class="post_content_holder">
				...
				<div class="post_text">
					<div class="post_text_inner">
						<div itemprop="dateCreated" class="minimalist_date entry_date updated"><?php the_time(get_option('date_format')); ?><meta itemprop="interactionCount" content="UserComments: <?php echo get_comments_number(qode_get_page_id()); ?>"/></div>
						<h2 itemprop="name" class="entry_title"><a itemprop="url" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
						<div class="separator small center"></div>
						<?php qode_excerpt(); ?>
					</div>
