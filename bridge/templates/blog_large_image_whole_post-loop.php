					...
					<div class="post_text_inner">
						...
						<div class="post_info">
							...
							<?php if($blog_hide_comments != "yes"){ ?>
								<span class="dots"><em class="fa fa-square"></em></span><a itemprop="url" class="post_comments" href="<?php comments_link(); ?>" target="_self"><?php comments_number('0 ' . __('Comments','qode'), '1 '.__('Comment','qode'), '% '.__('Comments','qode') ); ?></a>
							<?php } ?>
							<?php if( $qode_like == "on" ) { ?>
									<span class="dots"><em class="fa fa-square"></em></span><div class="blog_like">
			...
			<div class="post_content_holder">
				<div class="post_text">
					<div class="post_text_inner">
						...
						<em class="link_mark fa fa-link pull-left"></em>
				...
				<div class="post_content_holder">
					<div class="post_text">
						<div class="post_text_inner">
							...
							<em class="qoute_mark fa fa-quote-right pull-left"></em>
							<div class="post_title entry_title">
