...
<div id="panel" class="default left" style="margin-left: -207px;">
   <div id="panel-admin">
		...
		<div class="panel-admin-box">
            <div class="alt_menu">
                <p class="accordion_toolbar_header ui-state-active">Alternative Menu <em class="fa fa-angle-right"></em> <span class="new">NEW</span></p>
            ...
            <div class="accordion_toolbar">
				<p class="accordion_toolbar_header">Header Type <em class="fa fa-angle-right"></em></p>
				<div class="accordion_toolbar_content">
				...
				<p class="accordion_toolbar_header">Header Top Menu <em class="fa fa-angle-right"></em></p>
				<div class="accordion_toolbar_content">
				...
				<p class="accordion_toolbar_header">Page Transitions <em class="fa fa-angle-right"></em></p>
				<div class="accordion_toolbar_content">
				...
				<p class="accordion_toolbar_header">Boxed Layout <em class="fa fa-angle-right"></em></p>
				<div class="accordion_toolbar_content">
				...
				<p class="accordion_toolbar_header">Choose Background <em class="fa fa-angle-right"></em></p>
				<div class="accordion_toolbar_content">
				...
				<p class="accordion_toolbar_header">Choose Pattern <em class="fa fa-angle-right"></em></p>
				<div class="accordion_toolbar_content">
				...
				<p class="accordion_toolbar_header">Colors <em class="fa fa-angle-right"></em></p>
				<div class="accordion_toolbar_content">
				...
				<p class="accordion_toolbar_header">Footer type <em class="fa fa-angle-right"></em></p>
				<div class="accordion_toolbar_content">
	...
	<a class="open" href="#"><span><em class="fa fa-cog"></em></span></a>
</div>
<?php
}
?>