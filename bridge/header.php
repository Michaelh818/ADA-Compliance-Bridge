...
<head>
	...
	<?php wp_head(); ?>
<!-- Global site tag (gtag.js) - Google Ads: 618012778 --> <script async src="https://www.googletagmanager.com/gtag/js?id=AW-618012778"></script> <script> window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'AW-618012778'); </script>
	<script> gtag('config', 'AW-618012778/LiaeCOukt_MBEOrA2KYC', { 'phone_conversion_number': '(818) 330-7012' }); </script>
                                    ...
                                    <div class="side_menu_button">
                                        ...
                                        <?php if($enable_popup_menu == "yes"){ ?>
                                            <a href="javascript:void(0)" class="popup_menu <?php echo $header_button_size.' '.$popup_menu_animation_style; ?>">
                                        		...
                                        		<?php } else { ?>
                                            		<span class="popup_menu_inner"><em class="line">&nbsp;</em></span>
                                            	<?php } ?>	
                                        	</a>
                                        <?php } ?>
                                        <?php if($enable_side_area == "yes" && $enable_popup_menu == 'no'){ ?>
