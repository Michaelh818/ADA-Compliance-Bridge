...
function initFlexSlider(){
    ...
    $j('.flexslider').each(function(){
        ...
        $this.flexslider({
            ...
            slideshow: slideshow,
            animation: animation,
            prevText: "<div><em class='fa fa-angle-left'></em></div>",
            nextText: "<div><em class='fa fa-angle-right'></em></div>",
            animationSpeed: 600,
		...
		if($j(this).find('ul').length === 0){
			...
			if(sections.length){
				sections.each(function(){
					...
					var li = $j("<li />");
					var icon = $j("<em />", {"class": 'fa '+section_icon});
...
function initPreviewSlider() {
	...
	sliders.each(function() {
		...
		main_slider.flexslider({
			...
			directionNav: true,
			controlNav: true,
            prevText: '<em class="icon-arrows-left"></em>', //'<span class="arrow_carrot-left"></span>',
            nextText: '<em class="icon-arrows-right"></em>', //'<span class="arrow_carrot-right"></span>',
			start: function(slider) {
...
function initInDeviceSlider() {
	...
	sliders.each(function() {
		...
		slider.flexslider({
			...
			controlNav: false,
            prevText: '<em class="icon-arrows-left"></em>',
            nextText: '<em class="icon-arrows-right"></em>',
			start: function(slider) {
				slider.find('img').addClass('visible');
...
function alterWPMLSwitcherHeaderBottom() {
	...
	if($j('.header_bottom .mobile_menu li.menu-item-language').length) {
		...
		if(typeof langDropdown !== 'undefined') {
			...
			langDropdown.prev('a').after('<span class="mobile_arrow"><em class="fa fa-angle-right"></em><em class="fa fa-angle-down"></em></span>');
