...
<div class="full_screen_holder"<?php if($full_screen_holder_style != "") { echo " style='".$full_screen_holder_style."'";} ?>>
	...
	<div class="full_screen_navigation_holder up_arrow"><div class="full_screen_navigation_inner"><a id="up_fs_button" href="#" target="_self"><em class='fa fa-angle-up'></em></a></div></div>
	<?php } ?>
	...
	<?php if (!isset($qode_options_proya['fss_navigation_button_position']) || $qode_options_proya['fss_navigation_button_position'] !== 'side_by_side'){?>
	<div class="full_screen_navigation_holder down_arrow"><div class="full_screen_navigation_inner"><a id="down_fs_button" href="#" target="_self"><em class='fa fa-angle-down'></em></a></div></div>
	<?php } ?>

	<?php if (isset($qode_options_proya['fss_navigation_button_position']) && $qode_options_proya['fss_navigation_button_position'] == 'side_by_side'){?>
	<div class="full_screen_navigation_holder side_by_side">
		<div class="full_screen_navigation_inner up_arrow"><a id="up_fs_button" href="#" target="_self"><em class='fa fa-angle-up'></em></a></div>
		<div class="full_screen_navigation_inner down_arrow"><a id="down_fs_button" href="#" target="_self"><em class='fa fa-angle-down'></em></a></div>
	</div>
	<?php } ?>
</div>
