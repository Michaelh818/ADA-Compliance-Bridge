	...
	// add classes to ul sub-menus
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				$item_output .= '<em class="menu_icon '.$icon.'"></em>';
                ...
                if($args->has_children && $angle_icon != "") {
                    $item_output .= '<em class="q_menu_arrow fa '.$angle_icon.'"></em>';
                }
		...
		// add main/sub classes to li's and links
		 function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($item->nolink == ""){
					$item_output .= '</a><span class="mobile_arrow"><em class="fa fa-angle-right"></em><em class="fa fa-angle-down"></em></span>';
				}else{
					$item_output .= '</h3><span class="mobile_arrow"><em class="fa fa-angle-right"></em><em class="fa fa-angle-down"></em></span>';
				}
			}
			$item_output .= $args->after;
