        ...
        if ($slider != "") {
            ...
            if ( have_posts() ) : $postCount = 0; while ( have_posts() ) : the_post();
                ...
                if (get_post_meta(get_the_ID(), "qode_slide_button1_animation_scroll", true) == "yes") {
					...
					$slide_button_V2_1_data = array(
						'data-' . $slide_button_1_data_start => $slide_button_1_data_start_custom_style,
						'data-' . $slide_button_1_data_end => $slide_button_1_data_end_custom_style
					);
                }
                ...
                if (get_post_meta(get_the_ID(), "qode_slide_button2_animation_scroll", true) == "yes") {
					...
					$slide_button_V2_2_data = array(
						'data-' . $slide_button_2_data_start => $slide_button_2_data_start_custom_style,
						'data-' . $slide_button_2_data_end => $slide_button_2_data_end_custom_style
					);
                }
                ...
                if(get_post_meta(get_the_ID(), "qode_slide-separator-after-title", true) == 'yes') {
					...
					$slide_separator_gradient_class	= '';
                    ...
                    $slide_separator_gradient		= get_post_meta(get_the_ID(), "qode_slide_separator_gradient", true);
					if($slide_separator_gradient == 'yes') {
						$slide_separator_gradient_class = ' qode-type1-gradient-left-to-right';
					}
                    ...
                    $html_text .= '<div style="'.$slide_separator_styles.'" class="separator small'. $slide_separator_gradient_class .'" ' . $slide_separator_bottom_data . '></div>';
                }
                ...
                if(get_post_meta(get_the_ID(), "qode_slide-button-label", true) != "" && get_post_meta(get_the_ID(), "qode_slide-button-link", true) != ""){
					...
					$first_btn_icon_pack = get_post_meta(get_the_ID(), 'qode_slide_button1_icon_pack', true);
					if($first_btn_icon_pack !== 'no_icon' || $first_btn_icon_pack != '') {

						$first_btn_icon_collection = $qodeIconCollections->getIconCollection($first_btn_icon_pack);
					...
					if(get_post_meta(get_the_ID(), "qode_slide_button_type", true) == 'qode-button-v2'){

						$button_v2_hover = get_post_meta(get_the_ID(), "qode_slide_button_v2_hover_type", true);
						$button_icon_gradient = get_post_meta(get_the_ID(), "qode_slide_button_v2_icon_gradient", true);

						$button_icon_params = array(
							'link' => get_post_meta(get_the_ID(), "qode_slide-button-link", true),
							'size' => 'medium',
							'type' => '',
							'custom_class' => 'qode-slide-button-1',
							//'hover_effect' => $button_v2_hover,
							'text' =>  get_post_meta(get_the_ID(), "qode_slide-button-label", true),
							'custom_attr' =>  $slide_button_V2_1_data,
						);
						if($first_btn_icon_pack != '' || $first_btn_icon_pack != 'no_icon'){
							$button_icon_params['icon_pack'] = $first_btn_icon_pack;
							$button_icon_params[qode_icon_collections()->getIconCollectionParamNameByKey($first_btn_icon_pack)]	=  get_post_meta(get_the_ID(), 'qode_slide_button1_icon_'.qode_icon_collections()->getIconCollectionParamNameByKey($first_btn_icon_pack), true);
						}
						if($button_icon_gradient == 'yes') {
							$button_icon_params['enable_icon_gradient'] = 'yes';
						}
						$html_text .= qode_get_button_v2_html($button_icon_params);
					} else {
                ...
                if(get_post_meta(get_the_ID(), "qode_slide-button-label2", true) != "" && get_post_meta(get_the_ID(), "qode_slide-button-link2", true) != ""){
					...
					$second_btn_icon_pack = get_post_meta(get_the_ID(), 'qode_slide_button2_icon_pack', true);
					if($second_btn_icon_pack !== 'no_icon' || $second_btn_icon_pack != '') {
						$second_btn_icon_collection = $qodeIconCollections->getIconCollection($second_btn_icon_pack);
					...
					if(get_post_meta(get_the_ID(), "qode_slide_button_type2", true) == 'qode-button-v2'){

						//$button2_v2_hover = get_post_meta(get_the_ID(), "qode_slide_button_v2_hover_type2", true);
						$button2_icon_gradient = get_post_meta(get_the_ID(), "qode_slide_button2_v2_icon_gradient", true);

						$button2_icon_params = array(
							'link' => get_post_meta(get_the_ID(), "qode_slide-button-link2", true),
							'size' => 'medium',
							'type' => '',
							'custom_class' => 'qode-slide-button-2',
							//'hover_effect' => $button2_v2_hover,
							'text' =>  get_post_meta(get_the_ID(), "qode_slide-button-label2", true),
							'custom_attrs' =>  $slide_button_V2_2_data,

						);

						if($second_btn_icon_pack != '' || $second_btn_icon_pack != 'no_icon'){
							$button2_icon_params['icon_pack'] = $second_btn_icon_pack;
							$button2_icon_params[qode_icon_collections()->getIconCollectionParamNameByKey($second_btn_icon_pack)] = get_post_meta(get_the_ID(), 'qode_slide_button2_icon_'.qode_icon_collections()->getIconCollectionParamNameByKey($second_btn_icon_pack), true);
						}

						if($button2_icon_gradient == 'yes') {
							$button2_icon_params['enable_icon_gradient'] = 'yes';
						}

						$html_text .= qode_get_button_v2_html($button2_icon_params);
					} else {
                ...
                if(get_post_meta(get_the_ID(), "qode_slide-anchor-button", true) !== '') {
                    ...
                    $html_text .= '<div class="slide_anchor_holder"><a '.$slide_anchor_style.' class="slide_anchor_button anchor" href="'.get_post_meta(get_the_ID(), "qode_slide-anchor-button", true).'"><em class="fa fa-angle-down"></em></a></div>';
                }
            ...
            if($found_slides > 1){
                ...
                if($show_navigation_arrows != "no"){
                    $html .= '<a class="left carousel-control" href="#qode-'.$slider.'" data-slide="prev" data-start="opacity: 0.35;" data-300="opacity:0;"><span class="prev_nav" '.$navigation_margin_top.'><em class="fa fa-angle-left"></em></span><span class="thumb_holder" '.$navigation_margin_top.'><span class="thumb_top clearfix"><span class="arrow_left"><em class="fa fa-angle-left"></em></span><span class="numbers"><span class="prev"></span> / '.$postCount.'</span></span><span class="img_outer"><span class="img"></span></span></span></a>';
                    $html .= '<a class="right carousel-control" href="#qode-'.$slider.'" data-slide="next" data-start="opacity: 0.35;" data-300="opacity:0;"><span class="next_nav" '.$navigation_margin_top.'><em class="fa fa-angle-right"></em></span><span class="thumb_holder" '.$navigation_margin_top.'><span class="thumb_top clearfix"><span class="numbers"> <span class="next"></span> / '.$postCount.'</span><span class="arrow_right"><em class="fa fa-angle-right"></em></span></span><span class="img_outer"><span class="img"></span></span></span></a>';
                }
            }
            $html .= '</div>';
        }
