...
if (!function_exists('blog_slider')) {
    ...
    function blog_slider($atts, $content = null) {
            ...
            while (have_posts()) : the_post();
                ...
                if ($type == "" || $type == "carousel"){
                    ...
                    if($info_position == "info_in_bottom_always"){
                        ...
                        $html .= '<meta itemprop="interactionCount" content="UserComments:' . get_comments_number(qode_get_page_id()) . '"/></div>';
                        $html .= '</div>';
                        ...
                        if ($show_date == 'yes') {
                            ...
                            $html .= '<meta itemprop="interactionCount" content="UserComments: ' . get_comments_number(qode_get_page_id()) . '"/></span>';
                        }
        ...
        if ($enable_navigation) {
            $html .= '<ul class="caroufredsel-direction-nav"><li><a id="caroufredsel-prev" class="caroufredsel-prev" href="#"><div><em class="fa fa-angle-left"></em></div></a></li><li><a class="caroufredsel-next" id="caroufredsel-next" href="#"><div><em class="fa fa-angle-right"></em></div></a></li></ul>';
        }
        $html .= "</div></div>";
