	...
	public function render($factory) {
		...
		<div class="qodef-hidden-portfolio-images"  style="display: none">
			<div class="qodef-portfolio-toggle-holder">
				...
				<div class="qodef-portfolio-toggle qodef-portfolio-control">
					<span class="toggle-portfolio-media"><em class="fa fa-caret-up"></em></span>
					<a href="#" class="remove-portfolio-media"><em class="fa fa-times"></em></a>
				</div>
			</div>
		...
		<div class="qodef-hidden-portfolio-videos"  style="display: none">
			<div class="qodef-portfolio-toggle-holder">
				...
				<div class="qodef-portfolio-toggle qodef-portfolio-control">
					<span class="toggle-portfolio-media"><em class="fa fa-caret-up"></em></span> <a href="#" class="remove-portfolio-media"><em class="fa fa-times"></em></a>
				</div>
			</div>
			<div class="qodef-portfolio-toggle-content">
				<div class="qodef-page-form-section">
			...
			if ($portfolio_img_type == "image") {
				...
				<div class="qodef-portfolio-images qodef-portfolio-media" rel="<?php echo $no; ?>">
					<div class="qodef-portfolio-toggle-holder">
						...
						<div class="qodef-portfolio-toggle qodef-portfolio-control">
							<a href="#" class="toggle-portfolio-media"><em class="fa fa-caret-down"></em></a>
							<a href="#" class="remove-portfolio-media"><em class="fa fa-times"></em></a>
						</div>
					</div>
			...
			<?php
				...
				<div class="qodef-portfolio-videos qodef-portfolio-media" rel="<?php echo $no; ?>">
					<div class="qodef-portfolio-toggle-holder">
						...
						<div class="qodef-portfolio-toggle qodef-portfolio-control">
							<a href="#" class="toggle-portfolio-media"><em class="fa fa-caret-down"></em></a> <a href="#" class="remove-portfolio-media"><em class="fa fa-times"></em></a>
						</div>
					</div>
					<div class="qodef-portfolio-toggle-content" style="display: none">
						<div class="qodef-page-form-section">
		...
		<div class="qodef-portfolio-add">
			<a class="qodef-add-image btn btn-sm btn-primary" href="#"><em class="fa fa-camera"></em> Add Image</a>
			<a class="qodef-add-video btn btn-sm btn-primary" href="#"><em class="fa fa-video-camera"></em> Add Video</a>
	...
	public function render($factory) {
		...
		<div class="qodef-portfolio-additional-item-holder" style="display: none">
			<div class="qodef-portfolio-toggle-holder">
				...
				<div class="qodef-portfolio-toggle qodef-portfolio-control">
					<span class="toggle-portfolio-item"><em class="fa fa-caret-up"></em></span>
					<a href="#" class="remove-portfolio-item"><em class="fa fa-times"></em></a>
				</div>
			</div>
			<div class="qodef-portfolio-toggle-content">
				<div class="qodef-page-form-section">
		...
		while (isset($portfolios[$no-1])) {
			...
			<div class="qodef-portfolio-additional-item" rel="<?php echo $no; ?>">
				<div class="qodef-portfolio-toggle-holder">
					...
					<div class="qodef-portfolio-toggle qodef-portfolio-control">
						<span class="toggle-portfolio-item"><em class="fa fa-caret-down"></em></span>
						<a href="#" class="remove-portfolio-item"><em class="fa fa-times"></em></a>
					</div>
				</div>
				<div class="qodef-portfolio-toggle-content" style="display: none">
