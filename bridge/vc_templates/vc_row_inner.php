...
if($row_type == 'row') {
	...
	$output .='><span class="more_facts_button_text">'. $more_button_label .'</span><span class="more_facts_button_arrow"><em class="fa fa-angle-down"></em> </span></span>';
	$output .= '</div>';
	...
	$output .= '>';
	$output .= "<div class='nav_select_menu clearfix'><div class='nav_select_button'><em class='fa fa-bars'></em></div></div>";
}
